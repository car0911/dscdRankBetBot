...
# ==========================================
# 🔌 연결 상태 모니터링 및 자동 재연결 이벤트
# ==========================================

@bot.event
async def on_disconnect():
    print("⚠️ 경고: Discord 디스코드 서버와 연결이 끊어졌습니다. 재연결을 시도합니다...")

@bot.event
async def on_resumed():
    print("✅ 디스코드 서버와의 세션이 성공적으로 복구(Resume)되었습니다!")
...
async def slash_reset_command(interaction: discord.Interaction):
    # 0. 서버 내 사용 여부 및 Member 객체 안전하게 가져오기
